...
const uri = 'mongodb+srv://Gerald:abc.123@proyecto.2txle.mongodb.net/ProyectoGeral';
let client;
let db;
let chatCollection;
...
async function connectToMongoDB() {
    ...
    try {
        ...
        db = client.db('ProyectoGeral'); // Usamos la BD correcta
        ...
        console.log('Colección de chat y usuarios listas');
    } catch (error) {
